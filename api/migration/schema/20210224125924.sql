...
CREATE TABLE public.journals (
    ...
    karikata_cd character varying NOT NULL,
    karikata_value integer NOT NULL,
    kasikata_cd character varying NOT NULL,
...
--
-- Name: kamoku_bunrui_masters; Type: TABLE; Schema: public; Owner: kuronia
--

CREATE TABLE public.kamoku_bunrui_masters (
    id integer NOT NULL,
    kamoku_bunrui_cd character varying(1) NOT NULL,
    kamoku_bunrui_type character varying(5) NOT NULL,
    kamoku_bunrui_name text NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);


ALTER TABLE public.kamoku_bunrui_masters OWNER TO kuronia;

--
-- Name: kamoku_bunrui_masters_id_seq; Type: SEQUENCE; Schema: public; Owner: kuronia
--

CREATE SEQUENCE public.kamoku_bunrui_masters_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.kamoku_bunrui_masters_id_seq OWNER TO kuronia;

--
-- Name: kamoku_bunrui_masters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: kuronia
--

ALTER SEQUENCE public.kamoku_bunrui_masters_id_seq OWNED BY public.kamoku_bunrui_masters.id;
...
CREATE TABLE public.kamoku_masters (
    ...
    kamoku_zen_name text NOT NULL,
    kamoku_kana_name text NOT NULL,
    kamoku_bunrui_cd character varying(1) NOT NULL,
    kurikoshi_flag character varying(1) NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
CREATE TABLE public.saimoku_masters (
    ...
    saimoku_zen_name text NOT NULL,
    saimoku_ryk_name text NOT NULL,
    saimoku_han_name text NOT NULL,
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: kuronia
--
...
ALTER TABLE public.users OWNER TO kuronia;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: kuronia
--
...
ALTER TABLE public.users_id_seq OWNER TO kuronia;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: kuronia
--
...
--
-- Name: kamoku_bunrui_masters id; Type: DEFAULT; Schema: public; Owner: kuronia
--

ALTER TABLE ONLY public.kamoku_bunrui_masters ALTER COLUMN id SET DEFAULT nextval('public.kamoku_bunrui_masters_id_seq'::regclass);
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: kuronia
--
...
--
-- Name: kamoku_bunrui_masters kamoku_bunrui_masters_pkey; Type: CONSTRAINT; Schema: public; Owner: kuronia
--

ALTER TABLE ONLY public.kamoku_bunrui_masters
    ADD CONSTRAINT kamoku_bunrui_masters_pkey PRIMARY KEY (id);
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: kuronia
--
...
--
-- Name: index_journals_on_nendo; Type: INDEX; Schema: public; Owner: kuronia
--

CREATE INDEX index_journals_on_nendo ON public.journals USING btree (nendo);
