...
CREATE TABLE public.kamoku_bunrui_masters (
    ...
    kamoku_bunrui_name character varying(8) NOT NULL,
    kamoku_bunrui_type character varying(1) NOT NULL,
    kurikoshi_flg character varying(1) NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
CREATE TABLE public.saimoku_masters (
    id integer NOT NULL,
    kamoku_cd character varying(2) NOT NULL,
    saimoku_cd character varying(3) NOT NULL,
