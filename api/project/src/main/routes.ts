...
function buildRoute() {
  ...
  addRoute(POST, "/api/v1/ledger/:nendo/:ledgerCd", container.get<JournalController>(TYPES.JournalController), (controller) => controller.createLedger);
  addRoute(PUT, "/api/v1/ledger/:nendo/:ledgerCd", container.get<JournalController>(TYPES.JournalController), (controller) => controller.updateLedger);
